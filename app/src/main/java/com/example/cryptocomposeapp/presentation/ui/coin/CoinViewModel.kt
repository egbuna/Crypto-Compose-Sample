...
import com.example.cryptocomposeapp.domain.usecase.GetCoinUseCase
...
import com.example.cryptocomposeapp.common.Constant.PARAM_COIN_ID
    ...
    private fun getCoin(coinId: String) {
        useCase(coinId).onEach { result ->
            ...
            when (result) {
                ...
                is Resource.Success -> _state.value = CoinDetailState(success = result.data)
            }
